...
LT(BUTTON, KC_SLSH), ALGR_T(KC_V),      KC_G,              KC_P,              KC_B,              KC_X,              KC_W,              KC_DOT,            ALGR_T(KC_ENT),    LT(BUTTON, KC_QUOT), \
U_NP,              U_NP,              LT(MEDIA, KC_ESC), LT(NAV, KC_SPC),   LT(MOUSE, KC_TAB), LT(SYM, KC_BSPC),  LT(NUM, KC_E),     LT(FUN, KC_DEL),   U_NP,              U_NP
