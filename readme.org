...
#+NAME: hold
| BOOT   | DF(TAP) | DF(EXTRA) | DF(BASE) | BT_CLR | BT_CLR | DF(BASE) | DF(EXTRA) | DF(TAP) | BOOT   |
| LGUI   | LALT    | LCTL      | LSFT     |        |        | LSFT     | LCTL      | LALT    | LGUI   |
| BUTTON | ALGR    | LOCK_OPP  | LOCK_CUR |        |        | LOCK_CUR | LOCK_OPP  | ALGR    | BUTTON |
...
| DEL       | DEL       | DEL               | del          |
| DF(BASE)  | DF(BASE)  | &to BASE          | U_DF(BASE)   |
| DF(EXTRA) | DF(EXTRA) | &to EXTRA         | U_DF(EXTRA)  |
| DF(TAP)   | DF(TAP)   | &to TAP           | U_DF(TAP)    |
| DLR       | DLR       | DLLR              | $            |
| DOT       | DOT       | DOT               | .            |
| DOWN      | DOWN      | DOWN              | down         |
...
#+BEGIN_SRC python :session :var hold_table=hold :var mode="r" :var half_table=mouse-r :var current_layer_name="MOUSE" :var opposite_layer_name="SYM" :var shift="false" :tangle no :results verbatim
...
<<table-layer-half(current_layer_name="NAV", opposite_layer_name="NUM", half_table=nav-l-invertedt, mode="l", hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_NAV_FLIP \
<<table-layer-half(current_layer_name="NAV", opposite_layer_name="NUM", half_table=nav-l, mode="l", hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_NAV_INVERTEDT \
<<table-layer-half(current_layer_name="NAV", opposite_layer_name="NUM", half_table=nav-r-invertedt, mode="r")>>

#define MIRYOKU_ALTERNATIVES_NAV_VI \
<<table-layer-half(current_layer_name="NAV", opposite_layer_name="NUM", half_table=nav-r-vi, mode="r")>>

#define MIRYOKU_ALTERNATIVES_NAV \
<<table-layer-half(current_layer_name="NAV", opposite_layer_name="NUM", half_table=nav-r, mode="r")>>


#define MIRYOKU_ALTERNATIVES_MOUSE_INVERTEDT_FLIP \
<<table-layer-half(current_layer_name="MOUSE", opposite_layer_name="SYM", half_table=mouse-l-invertedt, mode="l", hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_MOUSE_FLIP \
<<table-layer-half(current_layer_name="MOUSE", opposite_layer_name="SYM", half_table=mouse-l, mode="l", hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_MOUSE_INVERTEDT \
<<table-layer-half(current_layer_name="MOUSE", opposite_layer_name="SYM", half_table=mouse-r-invertedt, mode="r")>>

#define MIRYOKU_ALTERNATIVES_MOUSE_VI \
<<table-layer-half(current_layer_name="MOUSE", opposite_layer_name="SYM", half_table=mouse-r-vi, mode="r")>>

#define MIRYOKU_ALTERNATIVES_MOUSE \
<<table-layer-half(current_layer_name="MOUSE", opposite_layer_name="SYM", half_table=mouse-r, mode="r")>>


#define MIRYOKU_ALTERNATIVES_MEDIA_INVERTEDT_FLIP \
<<table-layer-half(current_layer_name="MEDIA", opposite_layer_name="FUN", half_table=media-l-invertedt, mode="l", hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_MEDIA_FLIP \
<<table-layer-half(current_layer_name="MEDIA", opposite_layer_name="FUN", half_table=media-l, mode="l", hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_MEDIA_INVERTEDT \
<<table-layer-half(current_layer_name="MEDIA", opposite_layer_name="FUN", half_table=media-r-invertedt, mode="r")>>

#define MIRYOKU_ALTERNATIVES_MEDIA_VI \
<<table-layer-half(current_layer_name="MEDIA", opposite_layer_name="FUN", half_table=media-r-vi, mode="r")>>

#define MIRYOKU_ALTERNATIVES_MEDIA \
<<table-layer-half(current_layer_name="MEDIA", opposite_layer_name="FUN", half_table=media-r, mode="r")>>


#define MIRYOKU_ALTERNATIVES_NUM_FLIP \
<<table-layer-half(current_layer_name="NUM", opposite_layer_name="NAV", half_table=num-r, mode="r", hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_NUM \
<<table-layer-half(current_layer_name="NUM", opposite_layer_name="NAV", half_table=num-l, mode="l")>>


#define MIRYOKU_ALTERNATIVES_SYM_FLIP \
<<table-layer-half(current_layer_name="SYM", opposite_layer_name="MOUSE", half_table=sym-r, mode="r", hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_SYM \
<<table-layer-half(current_layer_name="SYM", opposite_layer_name="MOUSE", half_table=sym-l, mode="l")>>


#define MIRYOKU_ALTERNATIVES_FUN_FLIP \
<<table-layer-half(current_layer_name="FUN", opposite_layer_name="MEDIA", half_table=fun-r, mode="r", hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_FUN \
<<table-layer-half(current_layer_name="FUN", opposite_layer_name="MEDIA", half_table=fun-l, mode="l")>>
