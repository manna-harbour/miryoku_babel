...
Source keycode to implementation equivalent (source, QMK, ZMK, KMonad, SVG).
...
| 8           | 8                | NUM_8         | 8             | 8             |
| 9           | 9                | NUM_9         | 9             | 9             |
| ALGR        | ALGR             | RALT          | ralt          | AltGr         |
| AMPR        | AMPR             | AMPS          | &             | &amp;         |
| APP         | APP              | K_APP         | comp          | App           |
| ASTR        | ASTR             | ASTRK         | *             | *             |
| AT          | AT               | AT            | @             | @             |
| BSLS        | BSLS             | BSLH          | \\            | \\            |
| BSPC        | BSPC             | BSPC          | bspc          | Bckspc        |
| BOOT        | TD(U_TD_BOOT)    | U_BOOT        |               | Boot          |
| BT_CLR      |                  | &bt BT_CLR    |               | Clear         |
| BT_CLR_0    |                  |               |               | BT Clr 0      |
| BT_CLR_1    |                  |               |               | BT Clr 1      |
| BT_CLR_2    |                  |               |               | BT Clr 2      |
| BT_CLR_3    |                  |               |               | BT Clr 3      |
| BT_CLR_4    |                  |               |               | BT Clr 4      |
| BT_SEL_0    |                  | &u_bt_sel_0   |               | BT Sel 0      |
| BT_SEL_1    |                  | &u_bt_sel_1   |               | BT Sel 1      |
| BT_SEL_2    |                  | &u_bt_sel_2   |               | BT Sel 2      |
| BT_SEL_3    |                  | &u_bt_sel_3   |               | BT Sel 3      |
| BT_SEL_4    |                  | &u_bt_sel_4   |               | BT Sel 4      |
| BTN1        | U_BTN1           | U_BTN1        | U_BTN1        | Left Button   |
| BTN2        | U_BTN2           | U_BTN2        | U_BTN2        | Right Button  |
| BTN3        | U_BTN3           | U_BTN3        | U_BTN3        | Middle Button |
| CAPS        | CAPS             | CAPS          | caps          | Cps Lck       |
| CIRC        | CIRC             | CRRT          | ^             | ^             |
| COLN        | COLN             | COLON         | :             | :             |
| COMM        | COMM             | COMMA         | U_COMM        | S_COMM        |
| CPSWRD      | CW_TOGG          | &u_caps_word  | caps          | Cps Wrd       |
| DEL         | DEL              | DEL           | del           | Delete        |
| DF(U_BASE)  | TD(U_TD_U_BASE)  | &u_to_U_BASE  | U_DF(U_BASE)  | U_DF(U_BASE)  |
| DF(U_EXTRA) | TD(U_TD_U_EXTRA) | &u_to_U_EXTRA | U_DF(U_EXTRA) | U_DF(U_EXTRA) |
| DF(U_TAP)   | TD(U_TD_U_TAP)   | &u_to_U_TAP   | U_DF(U_TAP)   | U_DF(U_TAP)   |
| DLR         | DLR              | DLLR          | $             | $             |
| DOT         | DOT              | DOT           | .             | .             |
| DOWN        | DOWN             | DOWN          | down          | Down          |
| DQUO        | DQUO             | DQT           | U_DQUO        | &quot;        |
| END         | END              | END           | end           | End           |
| ENT         | ENT              | RET           | ent           | Enter         |
| EP_OFF      |                  |               |               | EP Off        |
| EP_TOG      |                  | U_EP_TOG      |               | EP Tog        |
| EQL         | EQL              | EQL           | =             | =             |
| ESC         | ESC              | ESC           | esc           | Esc           |
| EXLM        | EXLM             | EXCL          | !             | !             |
| F1          | F1               | F1            | f1            | F1            |
...
| INS         | INS              | INS           | ins           | Insert        |
| LALT        | LALT             | LALT          | alt           | Alt           |
| LBRC        | LBRC             | LBKT          | [             | [             |
| LCBR        | LCBR             | LBRC          | {             | {             |
| LCTL        | LCTL             | LCTRL         | ctl           | Ctrl          |
| LEFT        | LEFT             | LEFT          | left          | Left          |
| LGUI        | LGUI             | LGUI          | met           | Meta          |
| LPRN        | LPRN             | LPAR          | U_LPRN        | S_LPRN        |
| LSFT        | LSFT             | LSHFT         | sft           | Shift         |
| LT          | LT               | LT            | <             | &lt;          |
| MINS        | MINS             | MINUS         | -             | -             |
| MNXT        | MNXT             | C_NEXT        | nextsong      | Next          |
| MPLY        | MPLY             | C_PP          | playpause     | Play Pause    |
| MPRV        | MPRV             | C_PREV        | previoussong  | Prev          |
| MS_D        | MS_D             | U_MS_D        | kp2           | Mouse Down    |
| MS_L        | MS_L             | U_MS_L        | kp4           | Mouse Left    |
| MS_R        | MS_R             | U_MS_R        | kp6           | Mouse Right   |
| MS_U        | MS_U             | U_MS_U        | kp8           | Mouse Up      |
| MSTP        | MSTP             | C_STOP        | stopcd        | Stop          |
| MUTE        | MUTE             | C_MUTE        | mute          | Mute          |
| NO          | NO               | &none         | XX            |               |
| OUT_TOG     | OU_AUTO          | &u_out_tog    |               | Out Tog       |
| OUT_BT      | OU_BT            | &out OUT_BT   |               | Out BT        |
| OUT_USB     | OU_USB           | &out OUT_USB  |               | Out USB       |
| PAUS        | PAUS             | PAUSE_BREAK   | pause         | Pause Break   |
| PERC        | PERC             | PRCT          | %             | %             |
| PGDN        | PGDN             | PG_DN         | pgdn          | Page Down     |
| PGUP        | PGUP             | PG_UP         | pgup          | Page Up       |
| PIPE        | PIPE             | PIPE          | U_PIPE        | S_PIPE        |
| PLUS        | PLUS             | PLUS          | +             | +             |
| PSCR        | PSCR             | PSCRN         | sysrq         | PrtScn SysRq  |
| QUES        | QUES             | QMARK         | ?             | ?             |
| QUOT        | QUOT             | SQT           | U_QUOT        | &apos;        |
| RBRC        | RBRC             | RBKT          | ]             | ]             |
| RCBR        | RCBR             | RBRC          | }             | }             |
| RESET       |                  | &reset        |               | Reset         |
| RGB_HUD     | RGB_HUD          |               |               | RGB H-        |
| RGB_HUI     | RGB_HUI          | U_RGB_HUI     |               | RGB H+        |
| RGB_MOD     | RGB_MOD          | U_RGB_EFF     |               | RGB M+        |
| RGB_RMOD    | RGB_RMOD         |               |               | RGB M-        |
| RGB_OFF     |                  |               |               | RGB Off       |
| RGB_SAD     | RGB_SAD          |               |               | RGB S-        |
| RGB_SAI     | RGB_SAI          | U_RGB_SAI     |               | RGB S+        |
| RGB_TOG     | RGB_TOG          | U_RGB_TOG     |               | RGB Tog       |
| RGB_VAD     | RGB_VAD          |               |               | RGB V-        |
| RGB_VAI     | RGB_VAI          | U_RGB_BRI     |               | RGB V+        |
| RGHT        | RGHT             | RIGHT         | right         | Right         |
| RPRN        | RPRN             | RPAR          | U_RPRN        | S_RPRN        |
| SCLN        | SCLN             | SEMI          | ;             | ;             |
| SLCK        | SCRL             | SLCK          | slck          | Scroll Lock   |
| SLSH        | SLSH             | SLASH         | /             | /             |
| SPC         | SPC              | SPC           | spc           | Space         |
| TAB         | TAB              | TAB           | tab           | Tab           |
| TILD        | TILD             | TILDE         | ~             | ~             |
| TRNS        | TRNS             | &trans        | _             | Trans         |
| UNDS        | UNDS             | UNDER         | \_            | _             |
| UP          | UP               | UP            | up            | Up            |
| VOLD        | VOLD             | C_VOL_DN      | vold          | Volume Down   |
| VOLU        | VOLU             | C_VOL_UP      | volu          | Volume Up     |
| WH_D        | WH_D             | U_WH_D        |               | Scroll Down   |
| WH_L        | WH_L             | U_WH_L        |               | Scroll Left   |
| WH_R        | WH_R             | U_WH_R        |               | Scroll Right  |
| WH_U        | WH_U             | U_WH_U        |               | Scroll Up     |


**** table-layer-init

#+NAME: table-layer-init
#+BEGIN_SRC python :session :var symbol_names_table=symbol-names :var shifted_names_table=shifted-names :var nonkc_table=nonkc :var nonkp_table=nonkp :var nonquote_table=nonquote :var keycode_translation_table=keycode-translation :var layers_table=layers :var mods_table=mods :var target="svg" :tangle no :results verbatim
def wrap_basic(code):
...
if target == 'qmk':
  ...
  basic_prefix = 'KC_'
  basic_suffix = ''
  for source, qmk, zmk, kmonad, long in keycode_translation_table:
  ...
  for lr, hold_row_lr in ('l', hold_row_l), ('r', hold_row_r):
	...
	for half in half_row:
	  ...
	  if shift == "true" and shifted_code != None:
	    ...
	    code = 'U_S(' + str(wrap_basic(shifted_code)) + ', ' + str(wrap_basic(get_translated(code))) +')'
	  code = get_translated(code)
	  if code == '':
	    code = 'U_NU'
	  code = wrap_basic(code)
