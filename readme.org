...
| AT          | AT               | AT            | @             | @             | AT            |
| BSLS        | BSLS             | BSLH          | \\            | \\            | BSLS          |
| BSPC        | BSPC             | BSPC          | bspc          | Bckspc        | BSPC          |
| BOOT        | TD(U_TD_BOOT)    | U_BOOT        |               | Boot          | U_BOOT        |
...
| BTN1        | U_BTN1           | U_BTN1        | U_BTN1        | Left Button   | MB_LMB        |
| BTN2        | U_BTN2           | U_BTN2        | U_BTN2        | Right Button  | MB_RMB        |
| BTN3        | U_BTN3           | U_BTN3        | U_BTN3        | Middle Button | MB_MMB        |
| CAPS        | CAPS             | CAPS          | caps          | Cps Lck       | CAPS          |
| CIRC        | CIRC             | CRRT          | ^             | ^             | CIRC          |
| COLN        | COLN             | COLON         | :             | :             | COLN          |
| COMM        | COMM             | COMMA         | U_COMM        | S_COMM        | COMM          |
| CPSWRD      | CW_TOGG          | &u_caps_word  | caps          | Cps Wrd       | U_CW          |
...
| NO          | NO               | &none         | XX            |               | NO            |
| OUT_TOG     | OU_AUTO          | &u_out_tog    |               | Out Tog       | HID           |
...
| RGB_HUD     | RGB_HUD          |               |               | RGB H-        | U_RGB_HUD     |
| RGB_HUI     | RGB_HUI          | U_RGB_HUI     |               | RGB H+        | U_RGB_HUI     |
| RGB_MOD     | RGB_MOD          | U_RGB_EFF     |               | RGB M+        | U_RGB_MOD     |
| RGB_RMOD    | RGB_RMOD         |               |               | RGB M-        | U_RGB_RMOD    |
| RGB_OFF     |                  |               |               | RGB Off       | U_RGB_OFF     |
| RGB_SAD     | RGB_SAD          |               |               | RGB S-        | U_RGB_SAD     |
| RGB_SAI     | RGB_SAI          | U_RGB_SAI     |               | RGB S+        | U_RGB_SAI     |
| RGB_TOG     | RGB_TOG          | U_RGB_TOG     |               | RGB Tog       | U_RGB_TOG     |
| RGB_VAD     | RGB_VAD          |               |               | RGB V-        | U_RGB_VAD     |
| RGB_VAI     | RGB_VAI          | U_RGB_BRI     |               | RGB V+        | U_RGB_VAI     |
